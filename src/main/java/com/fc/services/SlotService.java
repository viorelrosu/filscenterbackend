...
public class SlotService {
	...
	// VALIDAR
	public boolean validarSlot(Slot slot) {
		if (slot.getDiaSemana() != null && !slot.getDiaSemana().contentEquals("")) {
			if (slot.getHoraInicio() != null) {
				if (slot.getSala() != null) {
					if (slot.getActividad() != null) {
						if (slot.getMonitor() != null) {
							return true;
						}
					}
				}
